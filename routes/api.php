...
Route::post('validatePayment', [DashboardController::class, 'validatePayment']);
// command route
...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::post('/getDaywiseExpenses', [DashboardController::class, 'getDaywiseExpenses']);
    Route::post('/getDaywiseRevenue', [DashboardController::class, 'getDaywiseRevenue']);
    Route::post('/getDaywiseSales', [DashboardController::class, 'getDaywiseSales']);
    ...
    Route::get('room-category-availability', [DashboardController::class, 'roomCategoryAvailability']);
    ...
    // Coupon Routes
    Route::get('/coupon/agents', [CouponController::class,'getAgents']);
    Route::get('/coupon/search', [CouponController::class,'search']);
    Route::post('/coupon/update-status/{id}', [CouponController::class,'updateStatus']);
    ...
    Route::get('/newtransactions', [TransactionController::class, 'allNewTransactions']);
    ...
    Route::get('/all-agents-client', [ClientController::class, 'allAgentsClient']);
    ...
    Route::post('/client/payment', [ClientController::class, 'clientPaymentPay']);
    Route::post('/client/add-payment', [ClientController::class, 'clientPaymentAdd']);
    Route::post('/clients/{client}', [ClientController::class, 'update']);
    Route::apiResource('clients', ClientController::class);
    Route::post('/post', [ClientController::class, 'savebooking']);
    Route::get('/getting_client_detail', [ClientController::class, 'getting_client_detail']);
    ...
    Route::post('/get/supplier', [SupplierController::class, 'getSupplierCat']);
