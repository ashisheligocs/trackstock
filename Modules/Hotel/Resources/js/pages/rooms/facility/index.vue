                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'room.facility.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                                        ...
                                        <td>{{ data.room_facility_title }}</td>
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("rooms.facility.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "rooms.facility.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "rooms.facility.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "rooms.facility.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
    ...
    // Map Getters
    computed: {
        ...mapGetters("operations", ["items", "loading", "pagination", "appInfo", "items"]),
    },
    watch: {
        // watch search data
