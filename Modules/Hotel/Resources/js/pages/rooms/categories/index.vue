<template>
    <div class="mb-50">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card" v-if="$can('hotel-list') ||
                    $can('hotel-create') ||
                    $can('hotel-edit') ||
                    $can('hotel-view') ||
                    $can('hotel-delete')
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'room.category.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div id="printMe" class="table-responsive table-custom mt-3">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-show="hotelCategoryItems && hotelCategoryItems.length" v-for="(data, i) in hotelCategoryItems" :key="i">
                                        <td>
                                            <span>{{ i + 1 }}</span>
                                        </td>
                                        <td>{{ data.room_category_name }}</td>
                                    ...
                                    <tr v-show="!loading && (!hotelCategoryItems || !hotelCategoryItems.length)">
                                        <td colspan="12">
                                            <EmptyTable />
                                        </td>
                                    </tr>
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("rooms.list.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "rooms.list.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "rooms.list.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "rooms.list.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
