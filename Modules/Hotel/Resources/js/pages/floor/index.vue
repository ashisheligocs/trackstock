                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'floor.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("floor.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "floor.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "floor.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "floor.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
