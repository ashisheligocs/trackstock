                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'bed-type.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div id="printMe" class="table-responsive table-custom mt-3">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-show="hotelCategoryItems && hotelCategoryItems.length"
                                        v-for="(data, i) in hotelCategoryItems" :key="i">
                                        <td>
                                            <span>{{ i + 1 }}</span>
                                        </td>
                                        <td>{{ data.bedtypetitle }}</td>
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("bedType.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "bedType.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "bedType.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "bedType.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
