                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'food-category.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
...
<!--                                        <td>-->
<!--                                            <img :src="data?.image?.replace('public/', 'storage/')" alt="" srcset="" width="80">-->
<!--                                        </td>-->
                                        ...
                                        <td v-if="$can('restaurant-edit') ||
                                            ...
                                            " class="text-right no-print">
                                            <div class="btn-group">
                                                <router-link v-if="$can('restaurant-edit')" v-tooltip="$t('common.edit')" :to="{
                                                    name: 'food-category.edit',
                                                    params: { slug: data.id },
                                                }" class="btn btn-info btn-sm">
                                                    <i class="fas fa-edit" />
                                                </router-link>
                                                <a v-if="data.items_count <= 0 && $can('restaurant-delete')" v-tooltip="$t('common.delete')" href="#"
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("food_category.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "food_category.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "food_category.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "food_category.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
    ...
    methods: {
        ...
        async searchData(page = 1) {
            ...
            await this.$store.dispatch("operations/searchData", {
                path: "/api/food/category",
                term: this.query,
                currentPage: page + "&perPage=" + this.perPage,
