            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ $t('restaurant_item.create.page_title') }}
                        </h3>
                        <router-link :to="{ name: 'items' }" class="btn btn-dark float-right">
...
export default {
    ...
    metaInfo() {
        return { title: this.$t('restaurant_item.create.page_title') }
    },
    computed: {
    ...
    data: () => ({
        breadcrumbsCurrent: 'restaurant_item.create.breadcrumbs_current',
        breadcrumbs: [
            {
                name: 'restaurant_item.create.breadcrumbs_first',
                url: 'home',
            },
            {
                name: 'restaurant_item.create.breadcrumbs_second',
                url: 'restaurant_item',
            },
            {
                name: 'restaurant_item.create.breadcrumbs_active',
                url: '',
            },
        ],
        form: new Form({
    ...
    methods: {
        ...
        async saveMealPlan() {
            ...
            await this.form
                .post(window.location.origin + '/api/food/item/add')
                .then(() => {
                    toast.fire({
                        type: 'success',
                        title: this.$t('restaurant_item.create.success_msg'),
                    })
