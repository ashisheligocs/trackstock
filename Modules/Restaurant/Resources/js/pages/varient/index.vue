                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'varient.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("varient.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "varient.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "varient.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "varient.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
