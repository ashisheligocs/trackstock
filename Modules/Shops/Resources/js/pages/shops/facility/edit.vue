      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'facility' }" class="btn btn-dark float-right">
...
export default {
  ...
  methods: {
    // get category
    async getCategory() {
      const { data } = await this.form.get( window.location.origin + '/api/hotel/facility/edit/' + this.$route.params.slug)
      this.form.facility_title = data.data.facility_title
