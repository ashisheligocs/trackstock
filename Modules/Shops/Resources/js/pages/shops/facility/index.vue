<template>
              ...
              <div class="row justify-content-between">
                ...
                <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                  <div class="btn-group c-w-100">
                    ...
                    <router-link :to="{ name: 'facility.create' }"
  ...
  export default {
    ...
    metaInfo() {
      return { title: this.$t("hotel.facility.index.page_title") };
    },
    components: {
      DateRangePicker,
    },
    data: () => ({
      breadcrumbsCurrent: "hotel.facility.index.breadcrumbs_current",
      breadcrumbs: [
        {
          name: "hotel.facility.index.breadcrumbs_first",
          url: "home",
        },
        {
          name: "hotel.facility.index.breadcrumbs_second",
          url: "",
        },
      ],
      perPage: 10,
          ...
          if (result.value) {
            this.$store
              .dispatch("operations/deleteData", {
                path: "/api/hotel/facility/delete/",
                slug: slug,
              })
              .then((response) => {
                if (response === true) {
