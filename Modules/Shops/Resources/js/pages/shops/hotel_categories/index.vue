<template>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                  <div class="btn-group c-w-100">
                    ...
                    <router-link :to="{ name: 'hotel.category.create' }"
  ...
  export default {
    ...
    metaInfo() {
      return { title: this.$t("hotel.list.index.page_title") };
    },
    components: {
      DateRangePicker,
    },
    data: () => ({
      breadcrumbsCurrent: "hotel.list.index.breadcrumbs_current",
      breadcrumbs: [
        {
          name: "hotel.list.index.breadcrumbs_first",
          url: "home",
        },
        {
          name: "hotel.list.index.breadcrumbs_second",
          url: "",
        },
      ],
      perPage: 10,
          ...
          if (result.value) {
            this.$store
              .dispatch("operations/deleteData", {
                path: "/api/hotel/category/delete/",
                slug: slug,
              })
              .then((response) => {
                if (response === true) {
