                        ...
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'booking-type.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("bookingType.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "bookingType.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "bookingType.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "bookingType.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
