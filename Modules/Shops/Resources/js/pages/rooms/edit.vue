            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ $t('rooms.roomAdd.create.form_title') }}
                        </h3>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="roomdescription" v-model="form.roomdescription" type="text"
                                        ...
                                        name="roomdescription" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="no_of_person" v-model="form.no_of_person" type="number"
                                        ...
                                        name="no_of_person" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="extra_bed_capacity" v-model="form.extra_bed_capacity" type="text"
                                        class="form-control" :class="{ 'is-invalid': form.errors.has('extra_bed_capacity') }" name="extra_bed_capacity" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="no_of_child" v-model="form.no_of_child" type="number"
                                        ...
                                        name="no_of_child" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="room_rate" v-model="form.room_rate" type="number"
                                        ...
                                        name="room_rate" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="extra_bed_rate" v-model="form.extra_bed_rate" type="number"
                                        ...
                                        name="extra_bed_rate" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="per_person" v-model="form.per_person" type="number"
                                        ...
                                        name="per_person" :placeholder="$t('common.name_placeholder')" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="no_of_infant" v-model="form.no_of_infant" type="number"
                                        ...
                                        name="no_of_infant" :placeholder="$t('common.name_placeholder')" />
...
export default {
    ...
    metaInfo() {
        return { title: this.$t('rooms.roomAdd.edit.page_title') }
    },
    components: {
        Multiselect
    },
    ...
    data: () => ({
        breadcrumbsCurrent: 'rooms.roomAdd.edit.breadcrumbs_current',
        breadcrumbs: [
            {
                name: 'rooms.roomAdd.edit.breadcrumbs_first',
                url: 'home',
            },
            {
                name: 'rooms.roomAdd.edit.breadcrumbs_second',
                url: 'rooms.roomAdd',
            },
            {
                name: 'rooms.roomAdd.edit.breadcrumbs_active',
                url: '',
            },
        ],
        form: new Form({
    ...
    methods: {
        // get category
        async getMealPlan() {
            const { data } = await this.form.get(window.location.origin + '/api/room/view/' + this.$route.params.slug)  
            this.form.room_name = data.data.room_name
            this.room_category_id = data.data.roomcategory
            this.room_facility_id = data.data
            this.room_hotel_id = data.data.hotels
            this.room_bed_type_id = data.data.bed
            this.room_floor_id = data.data
            this.form.roomdescription = data.data.roomdescription
            this.form.no_of_person = data.data.no_of_person
            this.form.extra_bed_capacity = data.data.extra_bed_capacity
            this.form.no_of_child = data.data.no_of_child
            this.form.room_rate = data.data.room_rate
            this.form.extra_bed_rate = data.data.extra_bed_rate
            this.form.per_person = data.data.per_person
            this.form.no_of_infant = data.data.no_of_infant
        },
        // update category
