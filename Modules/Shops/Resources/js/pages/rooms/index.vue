                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                                <div class="btn-group c-w-100">
                                    ...
                                    <router-link :to="{ name: 'room.create' }" class="btn btn-primary">
                                        {{ $t("common.create") }}
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-show="hotelCategoryItems && hotelCategoryItems.length" v-for="(data, i) in hotelCategoryItems" :key="i">
                                        ...
                                        <td>{{ data?.roomcategory?.room_category_name }}</td>
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("rooms.roomAdd.index.page_title") };
    },
    components: {
        DateRangePicker,
    },
    data: () => ({
        breadcrumbsCurrent: "rooms.roomAdd.index.breadcrumbs_current",
        breadcrumbs: [
            {
                name: "rooms.roomAdd.index.breadcrumbs_first",
                url: "home",
            },
            {
                name: "rooms.roomAdd.index.breadcrumbs_second",
                url: "",
            },
        ],
        perPage: 10,
