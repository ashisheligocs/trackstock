...
use Modules\Shops\Entities\BookingComplementray;
use Modules\Shops\Entities\BookingDetails;
use Modules\Shops\Entities\BookingStatus;
use Modules\Shops\Entities\ClinetBookingDetails;
use Modules\Shops\Entities\Hotel;
use Modules\Shops\Entities\Room;
use Modules\Shops\Entities\BookingAmendStay;
use Modules\Shops\Traits\ApiResponse;
use Modules\Shops\Transformers\BookingGetResource;
use Modules\Shops\Transformers\CheckoutResource;
use Modules\Shops\Transformers\CheckOutRoomResource;
use Modules\Shops\Transformers\CommonResource;
use Modules\Shops\Http\Requests\BookingRequest;
use DB;
    ...
    public function checkout(Request $request, Booking $booking)
    {
        ...
        try {
            ...
            if ($creditAmt > 0) {
                ...
                /*Manage Order Status & Order Payment Status*/
    ...
    public function manageLedgerAfterCheckout($booking, $creditAmt, $actualRemaining = 0,$invoicePerson,$plutusId = NULL,$creditAmt1,$bankCharges)
    {
        ...
        if ($restOrdersTotal) {
            ...
            $restRevenueAccount->balanceTransactions()->create([
                ...
                'reason' => 'Order associated with booking [' . $booking->booking_number . ']',
                'type' => 1,
                'transaction_date' => now(),
                'cheque_no' => null,
                'receipt_no' => null,
