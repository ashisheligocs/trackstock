          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <router-link
                  v-if="$can('increment-create')"
                  :to="{ name: 'increments.create' }"
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <a
                        v-if="data.employee && data.employee.image"
                        href="#"
                        id="show-modal"
                    ...
                    <td>
                      <span v-if="data.employee"
                        >{{ data.employee.empID | withPrefix(employeePrefix) }}
                      </span>
                    </td>
                    <td>
                      <router-link
                    ...
                    <td>
                      <span v-if="data.employee"
                        >{{ data.employee.totalSalary | withCurrency }}
                      </span>
                    </td>
                    <td>
