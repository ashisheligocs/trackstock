      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'increments.index' }" class="btn btn-secondary float-right">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="incrementDate" v-model="form.incrementDate" type="date" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('incrementDate') }" name="incrementDate" min=""/>
...
export default {
  ...
  mounted(){
    if(this.user.back_days != '' && this.user.back_days != 'All'){
        ...
        document.getElementById("incrementDate").min = minDate.toISOString().split("T")[0];
    }
  },
  methods: {
    // get all employees
