            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  <label for="employeeName"
                    >{{ $t("employees.common.employee_name") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="employeeName"
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('employeeName') }"
                    name="employeeName"
                    :placeholder="
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  >
                  <vue-tel-input
                    :class="{ 'is-invalid': form.errors.has('mobileNumber') }"
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <select
                    ...
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('bloodGroup') }"
                    name="bloodGroup"
                  >
                    <option value="" selected disabled>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    type="date"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('joiningDate') }"
                    name="joiningDate"
                  />
