            ...
            <div class="col-12 col-md-5">
                ...
                <div class="row no-print">
                    ...
                    <div class="col-12 col-lg-2">
                        <button
                                type="reset"
                                class="btn btn-secondary float-right btn-block"
                                @click="form.reset()"
                        >
