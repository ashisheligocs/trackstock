    ...
    <div class="row">
      <div class="col-lg-12 col-xl-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="updateQuotation"
          ...
          >
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div
                  class="form-group"
                  :class="form.discountType == 1 ? 'col-md-2' : 'col-md-4'"
                >
                  <label for="discount"
                    >{{ $t("common.discount") }}
                  ...
                  <input
                    ...
                    step="any"
                    min="1"
                    :max="form.discountType == 1 ? 100 : form.netTotal"
                    class="form-control"
                ...
                <div v-if="form.discountType == 1" class="form-group col-md-2">
                  ...
                  <input
                    ...
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('totalDiscount') }"
                    name="totalDiscount"
                    readonly
                  />
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    name="transportCost"
                    :placeholder="$t('common.transport_cost_placeholder')"
                    @change="calculateSum"
                    @keyup="calculateSum"
                  />
              ...
              <div class="row">
                <div v-if="taxes" class="form-group col-md-4">
                  ...
                  <v-select
                    ...
                    name="orderTax"
                    :placeholder="$t('sales.common.quotation_tax_placeholder')"
                    @input="calculateSum"
                  />
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="netTotal"
                    v-model="form.netTotal"
                    type="number"
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('netTotal') }"
                    name="netTotal"
                    readonly
                  />
