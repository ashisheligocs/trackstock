  ...
  <div>
    ...
    <div class="row">
            ...
            <div class="row">
              <div class="col-md-10">
                <ul class="nav nav-pills">
                  ...
                  <li v-if="$can('purchase-list')" class="nav-item bg-transparent">
                    <a class="nav-link active outline_btn" href="#purchases" data-toggle="tab"
      ...
      pagination.total
                  ...
                  <li v-if="$can('purchase-return-list')" class="nav-item bg-transparent">
                    <a @click="getSupplierReturns" class="nav-link outline_btn" href="#purchase-returns"
                      data-toggle="tab">
      ...
      returnPagination.total
                  ...
                  <li v-if="$can('purchase-payment-list')" class="nav-item bg-transparent">
                    <a @click="getSupplierPayments" class="nav-link outline_btn" href="#purchase-payments"
                      data-toggle="tab">
      ...
      paymentPagination.total
                  ...
                  <li v-if="$can('non-purchase-payment-list')" class="nav-item bg-transparent">
                    <a @click="getNonPurchaseTransactions" class="nav-link outline_btn"
                      href="#non-purchase-transactions" data-toggle="tab">
              ...
              <div class="col-md-2 text-right">
                <div class="btn-group">
                  <a @click="generatePDF()" href="#" class="btn btn-dark" v-tooltip="$t('download')">
                    <i class="fas fa-download"></i>
                  </a>
                  <a @click="print()" href="#" class="btn btn-info" v-tooltip="$t('print')">
              ...
              <div v-if="$can('non-purchase-payment-list')" class="tab-pane" id="non-purchase-transactions">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row no-print" id="element-to-hide" data-html2canvas-ignore="true">
                      <div class="col-12 col-md-9 mb-2">
                        <search v-model="transactionsQuery" @reset-pagination="resetTransactionsPagination"
      ...
      " :pagination="transactionPagination" :offset="5" class="justify-flex-end" @paginate="transactionsPaginate" />
                    <!-- pagination-end -->
                  </div>
                  <!-- NEW PAGINATION END -->
                </div>
