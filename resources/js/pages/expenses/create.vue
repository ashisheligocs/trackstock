      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'expenses.index' }" class="btn btn-secondary float-right">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input id="reason" v-model="form.reason" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('reason') }" name="reason" :placeholder="
                      $t('expenses.list.common.expense_reason_placeholder')
                    " />
                ...
                <div v-if="items" class="form-group col-md-4">
                  <label for="subCategory">{{ $t('common.category_name') }}
                    <span class="required">*</span></label>
                  <v-select v-model="form.subCategory" :options="subCategory" label="name"
...
export default {
  ...
  methods: {
    ...
    async getAccounts() {
      ...
      // console.log(window.location.origin + (typeof this.form.hotel_id?.id === 'undefined') ? '/api/all-accounts' : '/api/all-accounts?hotel_id='+this.form.hotel_id?.id);
