      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'products.index' }" class="btn btn-secondary float-right">
               ...
               <div class="form-group col-md-6 col-xl-4">
                ...
                <div class="form-group col-md-6 col-xl-4">
                  ...
                  <input id="sellingPrice" v-model="form.sellingPrice" type="number" class="form-control" readonly
                    :class="{ 'is-invalid': form.errors.has('sellingPrice') }" name="sellingPrice" :placeholder="
                ...
                <div class="form-group col-md-6 col-xl-4">
                  ...
                  <input id="alertQuantity" v-model="form.alertQuantity" type="number" min="0" max="1000"
                    ...
                    name="alertQuantity" :placeholder="
