      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'adjustments.index' }" class="btn btn-secondary float-right">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="adjustmentDate" v-model="form.adjustmentDate" type="date" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('adjustmentDate') }" name="adjustmentDate" min=""/>
...
export default {
  ...
  mounted(){
    if(this.user.back_days != '' && this.user.back_days != 'All'){
        ...
        document.getElementById("adjustmentDate").min = minDate.toISOString().split("T")[0];
    }
  },
  methods: {
    // get the adjustment
