          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <router-link
                  v-if="$can('loan-payment-create')"
                  :to="{ name: 'loanPayments.create' }"
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <span v-if="data.loan"
                        >{{ data.loan.payable | withCurrency }}
                      </span>
                    </td>
                    <td>{{ data.amount | withCurrency }}</td>
                    <td>
                      <span v-if="data.interest"
                        >{{ data.interest | withCurrency }}
                      </span>
                    </td>
                    <td>
