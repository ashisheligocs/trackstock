      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'payroll.index' }" class="btn btn-secondary float-right">
              ...
              <div v-if="form.employee" class="row">
                <div class="form-group col-md-4">
                  ...
                  <input id="presentSalary" v-model="form.employee.totalSalary" type="number" step="any"
                    class="form-control" :class="{ 'is-invalid': form.errors.has('presentSalary') }"
                    name="presentSalary" readonly />
                </div>
                <div class="form-group col-md-4">
                  <label for="deductionAmount">{{
                      $t('payroll.common.deduction_amount')
                  }}</label>
                  <input id="deductionAmount" v-model="form.deductionAmount" type="number" step="any"
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input id="festivalBonus" v-model="form.festivalBonus" type="number" step="any" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('festivalBonus') }" name="festivalBonus" min="0"
                    :placeholder="
                      $t('payroll.common.festival_bonus_placeholder')
                    " @change="calculateTotalSalary" @keyup="calculateTotalSalary" />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input id="travelAllowance" v-model="form.travelAllowance" type="number" step="any"
                    class="form-control" :class="{
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input id="salaryDate" v-model="form.salaryDate" type="date" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('salaryDate') }" name="salaryDate" min=""/>
...
export default {
  ...
  mounted(){
    if(this.user.back_days != '' && this.user.back_days != 'All'){
        ...
        document.getElementById("salaryDate").min = minDate.toISOString().split("T")[0];
    }
  },
  methods: {
    // get all employees
