<template>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                {{ $t('cashbook.journal_entry.create.page_title') }}
              </h3>
            ...
            <!-- /.card-header -->
            <form role="form" @submit.prevent="saveJournalEntry" @keydown="form.onKeydown($event)">
            <div class="card-body">
              <div class="row">
  ...
  export default {
    ...
    metaInfo() {
      return { title: this.$t('cashbook.journal_entry.create.page_title') }
    },
    components: {
      HotTable
    },
    data: () => ({
      breadcrumbsCurrent: 'cashbook.journal_entry.create.breadcrumbs_current',
      breadcrumbs: [
        {
          name: 'cashbook.journal_entry.create.breadcrumbs_first',
          url: 'home',
        },
        {
          name: 'cashbook.journal_entry.create.breadcrumbs_second',
          url: '',
        },
        {
          name: 'cashbook.journal_entry.create.breadcrumbs_third',
          url: 'journalEntry.index',
        },
        {
          name: 'cashbook.journal_entry.create.breadcrumbs_active',
          url: '',
        },
      ],
      tData:[],
    ...
    methods: {
      ...
      async saveJournalEntry () {
        if(this.totalCredit == this.totalDebit){
          ...
          await this.form
            .post(window.location.origin + '/api/account/journal/add')
            .then(() => {
              toast.fire({
                type: 'success',
                title: this.$t('cashbook.journal_entry.create.success_msg'),
              })
          ...
          // alert('Please Match Debit and Credit');
        }
      }
    },
  }
