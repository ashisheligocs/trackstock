...
<!--                /></span>-->
                ...
                /></span>
                <span v-if="allData.client.phone"
                  ><strong>{{ $t("common.contact_number") }}:</strong>
                  {{ allData.client.phone }}<br
                /></span>
                <span v-if="allData.client.address"
                  ><strong>{{ $t("common.address") }}:</strong>
                  {{ allData.client.address }}<br
                /></span>
                  <span v-if="allData.client.nationality"
                  ><strong>{{ $t("common.nationality") }}:</strong>
                  {{ allData.client.nationality }}<br
                      /></span>
                      <span v-if="allData.client.gst"
                  ><strong>{{ $t("common.gst_number") }}:</strong>
                  {{ allData.client.gst }}<br
                      /></span>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <strong class="mt-4 d-block mb-2"
                >{{ $t("common.payment_details") }}:</strong
              >
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th>{{ inr }} {{ $t("common.invoice_total") }}</th>
                      <th>{{ inr }} {{ $t("common.paid_amount") }}</th>
                  ...
                  <tbody v-if="allData.invoice">
                    <tr>
                      ...
                      <td>{{ allData.invoice.invoiceTotal }}</td>
                ...
                <table v-if="allData.transaction" class="table">
                  <thead>
                    <tr>
                      ...
                      <th
                        v-if="
                          allData.transaction && allData.transaction.receipt_no
                        "
                      >
                        {{ $t("common.receipt_no") }}
                      </th>
