  ...
  <div>
    ...
    <div class="row">
      <div class="col-lg-12 col-xl-12">
        <div class="card">
          <div class="card-header">
            ...
            <router-link :to="{ name: 'invoicePayments.index' }" class="btn btn-secondary float-right">
      ...
      $t("common.invoice_total")
                  ...
                  <input id="clientInvoiceTotal" v-model="form.client.clientInvoiceTotal" type="text"
                    class="form-control" name="clientInvoiceTotal" readonly />
                </div>
                <div class="form-group col-md-4">
      ...
      $t("common.total_paid")
                ...
                <div class="form-group col-md-4">
                  ...
                  <input id="clientDue" v-model="form.client.clientDue" type="text" class="form-control"
                    name="clientDue" readonly />
                </div>
              </div>
      ...
      $t("common.paid_amount")
                ...
                <div class="form-group col-md-12" v-if="invoices" v-for="(item, index) in invoices" :key="index + '1'">
                  <!-- <p>{{ item.label }} Invoice Details</p> -->
                  <!-- {{ item }} -->
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-md-3">
      ...
      $t("common.invoice_no")
                        ...
                        <input type="text" :id="`invoiceNumber-${++i}`" class="form-control" :value="item.label"
                          readonly />
                      </div>
                      <div class="form-group col-md-3">
                        <!-- <label for="invoiceTotal">{{
      ...
      $t("common.invoice_due")
                        ...
                        <input type="text" :id="`invoiceDue-${i}`" class="form-control" :value="item.invoiceTotal"
                          readonly />
                      </div>
                      <div class="form-group col-md-3">
                        <!-- <label for="paidAmount">{{
      ...
      " required min="1" :max="item.originalDue" value="1" />
                  ...
                  <!-- >{{ $t("payments.common.select_invoice") }}
                    <span class="required">*</span></label
                  >
                  <v-select
                    ...
                    name="invoice"
                    :placeholder="
                      $t('payments.common.select_invoice_placeholder')
                    "
      ...
      $t("common.payment_date")
                  ...
                  <input id="paymentDate" v-model="form.paymentDate" type="date" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('paymentDate') }" name="paymentDate" min="" />
  ...
  watch: {
    items(newData) {
      ...
      if (this.$route.params.slug) {
        const selectedCustomer = newData.filter(obj => obj.id == this.$route.params.slug);
        this.form.client = selectedCustomer[0];
        this.getInvoices();
      }
    },
  },
