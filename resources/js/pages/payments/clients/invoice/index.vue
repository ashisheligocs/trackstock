<template>
  <div>
    ...
    <div class="row">
      ...
      " href="/payments/clients/invoice/excel" v-tooltip="$t('common.export_table')" class="btn btn-dark">
      ...
      (i + 1)
                    ...
                    <td class="text-left" v-if="data.invoice && invoicePrefix">
      ...
      data.invoice.invoiceNo | withPrefix(invoicePrefix)
                    ...
                    <td class="text-left" v-if="data.client">{{ data.client.name }}</td>
                    <td class="text-right" v-if="data.invoice">
