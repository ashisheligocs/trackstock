            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <router-link :to="{ name: 'nonPurchasePayments.index' }" class="btn btn-secondary float-right">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="form.supplier" class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="nonPurchaseTotal" v-model="form.nonPurchaseTotal" type="number"
                                           step="any"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="nonPurchasePaid" v-model="form.nonPurchasePaid" type="number" step="any"
                                           class="form-control" name="nonPurchasePaid" readonly/>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="currentDue">{{
                                        $t('payments.common.current_due')
                                        }}</label>
                                    <input id="nonPurchaseDue" v-model="form.nonPurchaseDue" type="number" step="any"
                                           class="form-control"
                            ...
                            <div class="row" v-if="form.type == 1 && accounts">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="availableBalance" v-model="form.availableBalance" type="text" step="any"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="amount" v-model="form.amount" type="number" step="any" min="1"
                                           ...
                                           name="amount"
                                           :placeholder="$t('common.amount_placeholder')" @change="updateValues"
                                           @keyup="updateValues"/>
