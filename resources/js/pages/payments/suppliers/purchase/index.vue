          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <router-link
                  v-if="$can('purchase-payment-create')"
                  :to="{ name: 'purchasePayments.create' }"
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td class="text-left" v-if="data.purchase">
                      <router-link
                    ...
                    <td class="text-left" v-if="data.supplier">{{ data.supplier.name }}</td>
                    <td v-if="data.purchase" class="text-right">
