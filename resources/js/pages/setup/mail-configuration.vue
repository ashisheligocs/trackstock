              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="mail_mailer"
                    >{{ $t("setup.mail_configuration.form.mail_mailer") }}
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_mailer') }"
                    name="mail_mailer"
                    :placeholder="
                      $t('setup.mail_configuration.form.mail_mailer')
                    "
                ...
                <div class="form-group col-md-12">
                  <label for="mail_host"
                    >{{ $t("setup.mail_configuration.form.mail_host") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="mail_host"
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_host') }"
                    name="mail_host"
                    :placeholder="$t('setup.mail_configuration.form.mail_host')"
                    required
                  />
                ...
                <div class="form-group col-md-12">
                  <label for="mail_port"
                    >{{ $t("setup.mail_configuration.form.mail_port") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="mail_port"
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_port') }"
                    name="mail_port"
                    :placeholder="$t('setup.mail_configuration.form.mail_port')"
                    required
                  />
                ...
                <div class="form-group col-md-12">
                  <label for="mail_username"
                    >{{ $t("setup.mail_configuration.form.mail_username") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="mail_username"
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_username') }"
                    name="mail_username"
                    :placeholder="
                      $t('setup.mail_configuration.form.mail_username')
                    "
                ...
                <div class="form-group col-md-12">
                  <label for="mail_password"
                    >{{ $t("setup.mail_configuration.form.mail_password") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="mail_password"
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mail_password') }"
                    name="mail_password"
                    :placeholder="
                      $t('setup.mail_configuration.form.mail_password')
                    "
                ...
                <div class="form-group col-md-12">
                  <label for="mail_encryption"
                    >{{ $t("setup.mail_configuration.form.mail_encryption") }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="mail_encryption"
