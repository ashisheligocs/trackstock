          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('companyTagline') }"
                    name="companyTagline"
                    :placeholder="
                      $t(
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('clientPrefix') }"
                    name="clientPrefix"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('supplierPrefix') }"
                    name="supplierPrefix"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('employeePrefix') }"
                    name="employeePrefix"
                    :placeholder="
                      $t(
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('proCatPrefix') }"
                    name="proCatPrefix"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('productPrefix') }"
                    name="productPrefix"
                    :placeholder="
                      $t(
              ...
              <div class="row">
                <div class="form-group col-lg-6 col-xl-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('expCatPrefix') }"
                    name="expCatPrefix"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-lg-6 col-xl-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('purchasePrefix') }"
                    name="purchasePrefix"
                    :placeholder="
                      $t(
              ...
              <div class="row">
                <div class="form-group col-lg-6 col-xl-3">
                  ...
                  <input
                    ...
                    v-model="form.purchaseReturnPrefix"
                    type="text"
                    class="form-control"
                    :class="{
                ...
                <div class="form-group col-lg-6 col-xl-3">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('invoicePrefix') }"
                    name="invoicePrefix"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-lg-6 col-xl-3">
                  ...
                  <input
                    ...
                    v-model="form.invoiceReturnPrefix"
                    type="text"
                    class="form-control"
                    :class="{
                ...
                <div class="form-group col-lg-6 col-xl-3">
                  <label for="bookingPrefix"
                    >{{
                      $t(
                        "setup.general_settings.index.code_prefixes.booking_prefix"
                      )
                    }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="bookingPrefix"
                    v-model="form.bookingPrefix"
                    type="text"
                    class="form-control"
                    :class="{
                      'is-invalid': form.errors.has('bookingPrefix'),
                    }"
                    name="bookingPrefix"
                    :placeholder="
                      $t(
                        'setup.general_settings.index.code_prefixes.booking_prefix_placeholder'
                      )
                    "
                  />
                  <has-error :form="form" field="bookingPrefix" />
                </div>
                <div class="form-group col-lg-6 col-xl-3">
                  <label for="gstPrefix"
                    >{{
                      $t(
                        "setup.general_settings.index.code_prefixes.gst_prefix"
                      )
                    }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="gstPrefix"
                    v-model="form.gstPrefix"
                    type="text"
                    class="form-control"
                    :class="{
                      'is-invalid': form.errors.has('gstPrefix'),
                    }"
                    name="gstPrefix"
                    :placeholder="
                      $t(
                        'setup.general_settings.index.code_prefixes.gst_prefix_placeholder'
                      )
                    "
                  />
                  <has-error :form="form" field="gstPrefix" />
                </div>
              </div>
              <br />
              <strong>{{
              ...
              <div class="row">
                ...
                <div v-if="this.allClients" class="form-group col-md-6">
                  <label for="client"
                    >{{
                      $t(
                  ...
                  <v-select
                    ...
                    label="name"
                    :class="{ 'is-invalid': form.errors.has('defaultClient') }"
                    name="client"
                    :placeholder="
                      $t(
              ...
              <div class="row">
                ...
                <!--/Default Account-->
                <div v-if="this.allAccounts" class="form-group col-md-6">
                  <label for="client"
                    >{{
                      $t(
                  ...
                  <v-select
                    ...
                    :options="allAccounts"
                    label="bankName"
                    :class="{ 'is-invalid': form.errors.has('defaultAccount') }"
                    name="account"
                    :placeholder="
                      $t(
                ...
                <!-- <div v-if="this.allVatRates" class="form-group col-md-4">
                  ...
                  <v-select
                    ...
                    label="name"
                    :class="{ 'is-invalid': form.errors.has('defaultVatRate') }"
                    name="vatRate"
                    :placeholder="
                      $t(
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="custom-file">
                    <input
                      ...
                      class="custom-file-input"
                      name="blackLogo"
                      :class="{ 'is-invalid': form.errors.has('blackLogo') }"
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="custom-file">
                    <input
                      ...
                      class="custom-file-input"
                      name="smallLogo"
                      :class="{ 'is-invalid': form.errors.has('smallLogo') }"
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="custom-file">
                    <input
                      ...
                      class="custom-file-input"
                      name="favicon"
                      :class="{ 'is-invalid': form.errors.has('favicon') }"
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('copyrightText') }"
                    name="copyrightText"
  ...
  methods: {
    ...
    assignValues() {
      if (this.appInfo) {
        ...
        this.form.bookingPrefix = this.appInfo.bookingPrefix;
        this.form.gstPrefix = this.appInfo.gstPrefix;
      }
    },
