        ...
        >
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="code"
                  >{{ $t("common.code") }}<span class="required">*</span></label
                >
                <input
                  id="code"
                  v-model="form.code"
              ...
              <div class="form-group">
                <label for="symbol"
                  >{{ $t("setup.currencies.common.symbol")
                ...
                <input
                  ...
                  name="symbol"
                  :placeholder="
                    $t('setup.currencies.common.symbol_placeholder')
                  "
                />
                ...
                <div class="form-group col-md-4">
                  ...
                  >
                    <option value="left">
                      {{
                        $t(
                          "setup.currencies.common.position_drop_down_item_one"
                        )
                      }}
                    </option>
                    <option value="right">
                      {{
                        $t(
                          "setup.currencies.common.position_drop_down_item_two"
                        )
                      }}
                    </option>
                  </select>
