            ...
            <div class="card-body">
              <div class="row" v-if="items">
                <div class="form-group col-md-6">
                  ...
                  <input id="returnReason" v-model="form.returnReason" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('returnReason') }" name="returnReason" :placeholder="
                      $t('purchases.returns.common.return_reason_placeholder')
                    " />
              ...
              <div v-if="form.purchase" class="row">
                <div class="form-group col-md-4">
                  ...
                  <input id="discount" v-model="form.purchase.totalDiscount" type="number" step="any"
                    class="form-control" name="discount" readonly />
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <has-error :form="form" field="date" min=""/>
                </div>
                <div class="form-group col-md-6">
