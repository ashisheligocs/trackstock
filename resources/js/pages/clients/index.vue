        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/clients/excel" v-tooltip="$t('common.export_table')" class="btn btn-dark ">
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <!-- {{ data.clientID | withPrefix(clientPrefix) }} <br/> -->
                      ...
                      <span v-if="data.hotel?.hotel_name" class="hotel_name">{{ data.hotel?.hotel_name}}</span>
                    </td>
                    <!-- <td>
                      <router-link v-if="$can('client-view')" :to="{
                        name: 'clients.show',
                    ...
                    <td>{{ data.type == 1 ? 'Customer' : 'Agent' }}</td>
                    <!--                    <td>-->
          ...
          <div class="card-footer">
            <div class="dtable-footer">
              <div v-if="shouldShowPerPageSelection" class="form-group row display-per-page">
              ...
              <div id="app" class="web-camera-container" style="display: none;">
