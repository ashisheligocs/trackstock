          ...
          <div class="col-lg-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title">{{ $t("clients.create.form_customer_agent") }}</h3>
                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="form-group col-md-6">
                                  ...
                                  <select id="type" @change="hideOption" v-model="form.type" class="form-control"
                              ...
                              <div class="form-group col-md-6" v-if="this.form.type == 1">
                              ...
                              <div class="form-group col-md-6" v-if="this.form.type == 2">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                  <label for="phoneNumber">{{ $t("common.contact_number") }}
                                      <span class="required">*</span></label>
                                  <vue-tel-input :class="{ 'is-invalid': form.errors.has('phoneNumber') }"
                                      v-model="form.phoneNumber" :inputOptions="{
                                          showDialCode: true,
                                      }"></vue-tel-input>
                          ...
                          <div class="row">
                              <div class="form-group">
                                  ...
                                  <!-- <label class="image_label" for="file-upload">Upload Image</label>
                                  <input type="file" id="file-upload" @change="camera_image"> -->
                                  ...
                                  <div v-if="isCameraOpen && !isLoading" class="camera-shoot">
                                      ...
                                      <button @click="toggleFlipCamera">Flip Camera</button>
                                  </div>
                                  

                                  <!-- <div v-if="isPhotoTaken && isCameraOpen" class="camera-download">
                                      <a id="downloadPhoto" download="my-photo.jpg" class="btn btn-dark button" role="button"  @click="downloadImage">Save </a>
                                  </div> -->
...
export default {
  ...
  // },
      ...
      hideOption(e) {
          var val = this.form.type;
          if (val == 2) {
              this.roles = [{ 'name': 'Agent', 'slug': 'agent' }];
          }
      },
      camera_image() {
