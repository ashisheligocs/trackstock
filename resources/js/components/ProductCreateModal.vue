<template>
  <div>
    <VModal
      v-model="showProductCreateModal"
          ...
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input
                ...
                type="text"
                class="form-control"
                :class="{ 'is-invalid': form.errors.has('itemModel') }"
                name="itemModel"
            ...
            <div class="form-group col-6">
              <div class="input-group">
                <label for="itemCode" class="col-md-12"
                  >{{ $t("common.item_code") }}
                  <span class="required">*</span></label
                >
                ...
                <input
                  ...
                  name="itemCode"
                  :placeholder="$t('common.item_code_placeholder')"
                  aria-label="itemCode"
            ...
            <div v-if="units" class="form-group col-6">
              <label for="itemUnit"
                >{{ $t("common.unit") }} <span class="required">*</span></label
              >
              <v-select
                v-model="form.itemUnit"
                :options="units"
                label="name"
                :class="{ 'is-invalid': form.errors.has('itemUnit') }"
                name="itemUnit"
            ...
            <div class="form-group col-6">
              <label for="regularPrice"
                >{{ $t("products.list.common.regular_price") }}</label
              >
              <input
                id="regularPrice"
            ...
            <div class="form-group col-6">
              ...
              <input
                ...
                name="sellingPrice"
                :placeholder="
                  $t('products.list.common.selling_price_placeholder')
                "
              />
            ...
            <div class="form-group col-6">
              ...
              <input
                ...
                max="1000"
                class="form-control"
                :class="{ 'is-invalid': form.errors.has('alertQuantity') }"
                name="alertQuantity"
                :placeholder="
                  $t('products.list.common.alert_quantity_placeholder')
                "
              />
...
export default {
  ...
  methods: {
    ...
    calculatePrice() {
      ...
      if (this.form.sellingPrice && this.form.taxType) {
      // if (this.form.sellingPrice && this.form.productTax && this.form.taxType) {
        ...
        let taxAmount = 0;
        let totalTax = 0;
        if (typeof this.form.productTax !== 'undefined'){
