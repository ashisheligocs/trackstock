<template>
  ...
  <aside class="main-sidebar">
    ...
    ">
          ...
          <!--------------------------Reports---------------------------------->
          <li 
          v-if="$can('balance-sheet') || $can('summary-report') || $can('profit-loss')
          ...
          <li data-v-6dde423b="" class="nav-item dropdown d-block d-md-none sidebar_user"><a data-v-6dde423b="" data-toggle="dropdown" href="#"
