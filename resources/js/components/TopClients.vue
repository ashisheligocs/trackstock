<template>
  <div v-if="topClients && topClients.length > 0" class="card">
    ...
    <div class="card-body row top_card-body">
      <div v-if="topClients[1] && topClients[1].client" class="col-sm-4 top_client_card">
      ...
      <div v-if="topClients[0] && topClients[0].client" class="col-sm-4 top_client_card">
      ...
      <div v-if="topClients[2] && topClients[2].client" class="col-sm-4 top_client_card">
        <div class="leaderboard-card">
          <div class="leaderboard-card__top text-center">
            <h5 class="text-center">
      ...
      <div v-if="topClients && topClients.length > 3" class="table-responsive">
        <table v-show="topClients.length > 3" class="clients-table table mb-0 leaderboard_table">
          <tbody>
