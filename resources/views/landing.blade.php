...
<head>
    ...
    <title>TackHotel | POS, Inventory, Accounting Application</title>
    <meta name="description"
        content="TackHotel is an all-in-one management system that enables you to manage expenses, purchases, sales, payments, accounting, loans, assets, payroll, and many more." />
    <meta name="author" content="ELIGOCS">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="https://www.eligocs.com/contact-us/" target="_blank"
                                            aria-label="Toggle navigation">Support</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                            <div class="button add-list-button">
                                <a href="https://codecanyon.net/item/acculance-ultimate-sales-inventory-accounting-management-system/37545480"
                                    class="btn">Buy now</a>
                            </div>
                        </nav>
                        <!-- End Navbar -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <h3>Purchase</h3>
                        <p>The Purchase module allows you to manage product purchases and returns. By creating purchases
                            the stock quantity of products will be increased and by deleting purchases the stock
                            quantity of products will be decreased.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <h3>Sales</h3>
                        <p>The Sales module allows you to manage sales quotations, product sales, and returns. By
                            creating sales the stock quantity of products will be decreased and by deleting sales the
                            stock quantity of products will be increased.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <p>The Accounting module allows you to manage transactions and accounts. Every transaction is
                            connected to cash or bank accounts. A credit transaction will increase the balance and a
                            debit transaction will decrease the balance.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <h3>Loan</h3>
                        <p>The Loan module helps you to manage loan authorities, loans, and loan payments. Acculance
                            allows you to create both CC loans & Term loans. The amount will be added to account and can
                            be used for transactions.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <h3>Asset</h3>
                        <p>The Asset module helps you manage your company assets and their deprecation. We have
                            implemented a straight-line depreciation method to calculate the deprecation. You can also
                            create assets without any deprecation.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <h3>Payroll</h3>
                        <p>The Payroll module helps you manage monthly salaries. Using the payroll module you can
                            generate monthly salaries for employees. Payrolls are connected with accounts so never allow
                            another payroll to go unaccounted.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <h3>Inventory</h3>
                        <p>The Inventory module helps you keep track of your product stocks and adjust stock by
                            increasing or decreasing stock. It helps to see the avg. purchase price including inventory
                            history(Stock In & Stock Outs) from this module.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <h3>Reports</h3>
                        <p>Reports are very important to every business. Acculance provides various reports to track
                            your business performance. You can easily check the balance sheet, summary report,
                            profit/loss report, expense report, and inventory report.</p>
                    </div>
                    <!-- End Single Feature -->
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-table wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="table-head">
                            ...
                            <div class="price">
                                <h2 class="amount">$27 <del>$49</del></h2>
                            </div>
                            <div class="button">
                                <a href="https://codecanyon.net/item/acculance-ultimate-sales-inventory-accounting-management-system/37545480"
                    ...
                    <div class="single-table wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <div class="table-head">
                            ...
                            <div class="button mt-5">
                                <a href="https://www.eligocs.com/contact-us/" target="_blank" class="btn">Contact
                                    Us</a>
                            </div>
                        </div>
                        <!-- End Table Head -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 text-center col-12">
                        ...
                        <div class="single-footer f-about">
                            ...
                            <ul class="social">
                                <li><a href="https://www.eligocs.com" target="_blank"><i
                            ...
                            <p class="copyright-text">Copyright &copy; By <a href="https://codeshaper.net/"
                                    rel="nofollow" target="_blank">EligoCS</a>
                            </p>
                        </div>
                        <!-- End Single Widget -->
                    </div>
